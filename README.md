...
- 741 generated HTML pages with matching `sitemap.xml` entries
- 60 machine intent pages, generated in 7 public language versions
- 257 English long-tail buyer-intent pages across applications, packaging formats, buying guides, industry insights, buyer-industry playbooks and packaging technologies
...
- 1220 mapped target search terms across product, format, cost, supplier, compliance, trend, role/persona and technical-intent pages
